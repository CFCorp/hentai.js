class HentaiJS {
    ...
    */
    ...
    /**
    * Gives some cute nekos :^)
    */
    neko() {
        return new Promise((result, reject) => {
            try {
                this._snek.get("https://api.computerfreaker.cf/v1/neko")
                    .set("User-Agent", this.useragent)
                    .then((r) => {
                        result(r.body.url);
                    });
    ...
    /**
    * Gives some cute nsfw nekos (NSFW) :^)
    */
    nsfwneko() {
        return new Promise((result, reject) => {
            try {
                this._snek.get("https://api.computerfreaker.cf/v1/nsfwneko")
                    .set("User-Agent", this.useragent)
                    .then((r) => {
                        result(r.body.url);
                    });
    ...
    */
    ...
    /**
    * Get some yuri (slightly nsfw sometimes) :^) 
    */
    yuri() {
        return new Promise((result, reject) => {
            try {
                this._snek.get("https://api.computerfreaker.cf/v1/yuri")
                    .set("User-Agent", this.useragent)
                    .then((r) => {
                        result(r.body.url);
                    });
